          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-background rounded-lg p-6 border shadow-sm">
              <div>
                ...
                <h3 className="font-medium text-lg mb-5">Quartos e camas</h3>
                ...
                <h3 className="font-medium text-lg mb-5">Tipo de propriedade</h3>
                ...
                <h3 className="font-medium text-lg mb-5">Comodidades</h3>
